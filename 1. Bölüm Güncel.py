...
# Gönder butonunu tanımlama ve yerleşim ayarı
gonder_butonu = Button(root, text='Gönder', command=bilirkisi_raporu)
gonder_butonu.grid(row=19, column=1, sticky=W, pady=4)  # Butonun konumunu ve padding ayarını burada yapabilirsiniz
